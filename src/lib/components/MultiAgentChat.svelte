...
<div class="chat-container">
    ...
    <div class="cards-container">
        <div class="card">Count the number of items in an image</div>
        <div class="card">Python script for daily email reports</div>
        <div class="card">Morning routine for productivity</div>
        <div class="card">Plan a relaxing day</div>
    </div>
</div>
...
.cards-container {
    ...
    z-index: 1; /* Ensure it hovers above other content */
